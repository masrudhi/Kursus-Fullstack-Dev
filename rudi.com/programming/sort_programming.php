...
<body>
	<center>
		...
		$urutan = $_POST['urutan'];
		if($urutan=='rank_asc')
			{$kueri =  "select * from programming order by rank asc";}
		else if($urutan=='rank_desc')
			{$kueri =  "select * from programming order by rank desc";}

		else if($urutan=='language_asc')
			{$kueri =  "select * from programming order by language asc";}
		else if($urutan=='language_desc')
			{$kueri =  "select * from programming order by language desc";}

		else if($urutan=='most_use_case_asc')
			{$kueri =  "select * from programming order by most_use_case asc";}
		else if($urutan=='most_use_case_desc')
			{$kueri =  "select * from programming order by most_use_case desc";}

		else if($urutan=='year_salary_asc')
			{$kueri =  "select * from programming order by year_salary asc";}
		else if($urutan=='year_salary_desc')
			{$kueri =  "select * from programming order by year_salary desc";}

		else if($urutan=='founder_asc')
			{$kueri =  "select * from programming order by founder asc";}
		else if($urutan=='founder_desc')
			{$kueri =  "select * from programming order by founder desc";}
