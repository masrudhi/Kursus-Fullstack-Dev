...
<?php
include 'koneksi.php';
$kueri = "select * from energy where
        rank like '%$_POST[kata_kunci]%' or 
        country like '%$_POST[kata_kunci]%' or 
        city like '%$_POST[kata_kunci]%' or 
        continent like '%$_POST[kata_kunci]%' or 
        energy_type like '%$_POST[kata_kunci]%' or 
        production_mw like '%$_POST[kata_kunci]%' or 
        co2_reduction like '%$_POST[kata_kunci]%'
        ";
